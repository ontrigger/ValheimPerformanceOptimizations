...
namespace RuntimeDebugDraw
{
    public static class Draw
    {
        ...
        ///     Check and build
        /// </summary>
        private static readonly string HIDDEN_GO_NAME = "________HIDDEN_C4F6A87F298241078E21C0D7C1D87A76_";
        ...
        private static void CheckAndBuildHiddenRTDrawObject()
        {
            ...
            _rtDraw = childGo.AddComponent<Internal.RuntimeDebugDraw>();
...
namespace RuntimeDebugDraw.Internal
{
    internal class RuntimeDebugDraw : MonoBehaviour
    {
        ...
        public void RegisterLine(Vector3 start, Vector3 end, Color color, float timer, bool noZTest)
        {
            ...
            for (var ix = 0; ix < _lineEntries.Count; ix++)
            {
        ...
        private void TickAndDrawLines()
        {
            ...
            Graphics.DrawMesh(_AlwaysBatch.mesh, Vector3.zero, Quaternion.identity, _AlwaysBatch.mat,
                              Draw.DrawLineLayer, null, 0, null, false, false);
            Graphics.DrawMesh(_ZTestBatch.mesh, Vector3.zero, Quaternion.identity, _ZTestBatch.mat, Draw.DrawLineLayer,
        ...
        public void RegisterDrawText(Vector3 anchor, string text, Color color, int size, float timer, bool popUp)
        {
            ...
            for (var ix = 0; ix < _drawTextEntries.Count; ix++)
            {
        ...
        public void RegisterAttachText(Transform target, Func<string> strFunc, Vector3 offset, Color color, int size)
        {
            ...
            for (var ix = 0; ix < _attachTextEntries.Count; ix++)
            {
        ...
        private void GUIAttachTextEntry(Camera camera, AttachTextEntry entry)
        {
            ...
            var worldPos = entry.transform.position + entry.offset;
            var screenPos = camera.WorldToScreenPoint(worldPos);
            screenPos.y = Screen.height - screenPos.y;
